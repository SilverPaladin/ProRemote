...
This starts Vite at <http://localhost:8000>. Open Settings in the app and enter the IP and port of the computer running ProPresenter (default port: `50001`). Make sure **Allow Network Connections** is enabled in ProPresenter's *Preferences → Network*.
